...
class Fireball(Entity):
    def __init__(self, x_pos, y_pos, move_direction: bool):
        ...
        self.images = [
            Filesystem.load_image('assets/images/fireball.png'),
            pg.transform.flip(Filesystem.load_image('assets/images/fireball.png'), 0, 90),
            pg.transform.flip(Filesystem.load_image('assets/images/fireball.png'), 90, 90),
            pg.transform.flip(Filesystem.load_image('assets/images/fireball.png'), 90, 0),
            Filesystem.load_image('assets/images/firework0.png'),
            Filesystem.load_image('assets/images/firework1.png'),
            Filesystem.load_image('assets/images/firework2.png')
        ]
