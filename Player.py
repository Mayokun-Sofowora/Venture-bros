...
class Player(object):
    def __init__(self, x_pos, y_pos):
        ...
        self.image = Filesystem.load_image('assets/images/mario/mikkey.png')
        self.sprites = []
        self.load_sprites()

        self.rect = pg.Rect(x_pos, y_pos, 28, 30)

    def load_sprites(self):
        self.sprites = [
            # 0 Small, stay
            Filesystem.load_image('assets/images/Mario/mikkey.png'),

            # 1 Small, move 0
            Filesystem.load_image('assets/images/Mario/mikkey_move0.png'),

            # 2 Small, move 1
            Filesystem.load_image('assets/images/Mario/mikkey_move1.png'),

            # 3 Small, move 2
            Filesystem.load_image('assets/images/Mario/mikkey_move2.png'),

            # 4 Small, jump
            Filesystem.load_image('assets/images/Mario/mikkey_jump.png'),

            # 5 Small, end 0
            Filesystem.load_image('assets/images/Mario/mikkey_end.png'),

            # 6 Small, end 1
            Filesystem.load_image('assets/images/Mario/mikkey_end1.png'),

            # 7 Small, stop
            Filesystem.load_image('assets/images/Mario/mikkey_st.png'),

            # =============================================

            # 8 Big, stay
            Filesystem.load_image('assets/images/Mario/mikkey1.png'),

            # 9 Big, move 0
            Filesystem.load_image('assets/images/Mario/mikkey1_move0.png'),

            # 10 Big, move 1
            Filesystem.load_image('assets/images/Mario/mikkey1_move1.png'),

            # 11 Big, move 2
            Filesystem.load_image('assets/images/Mario/mikkey1_move2.png'),

            # 12 Big, jump
            Filesystem.load_image('assets/images/Mario/mikkey1_jump.png'),

            # 13 Big, end 0
            Filesystem.load_image('assets/images/Mario/mikkey1_end.png'),

            # 14 Big, end 1
            Filesystem.load_image('assets/images/Mario/mikkey1_end1.png'),

            # 15 Big, stop
            Filesystem.load_image('assets/images/Mario/mikkey1_st.png'),

            # =============================================

            # 16 Big_fireball, stay
            Filesystem.load_image('assets/images/Mario/mikkey2.png'),

            # 17 Big_fireball, move 0
            Filesystem.load_image('assets/images/Mario/mikkey2_move0.png'),

            # 18 Big_fireball, move 1
            Filesystem.load_image('assets/images/Mario/mikkey2_move1.png'),

            # 19 Big_fireball, move 2
            Filesystem.load_image('assets/images/Mario/mikkey2_move2.png'),

            # 20 Big_fireball, jump
            Filesystem.load_image('assets/images/Mario/mikkey2_jump.png'),

            # 21 Big_fireball, end 0
            Filesystem.load_image('assets/images/Mario/mikkey2_end.png'),

            # 22 Big_fireball, end 1
            Filesystem.load_image('assets/images/Mario/mikkey2_end1.png'),

            # 23 Big_fireball, stop
            Filesystem.load_image('assets/images/Mario/mikkey2_st.png'),
        ]
        ...
        self.sprites.append(Filesystem.load_image('assets/images/Mario/mikkey_lvlup.png'))

        # Power level changing, left
        self.sprites.append(pg.transform.flip(self.sprites[-1], 180, 0))

        # Death
        self.sprites.append(Filesystem.load_image('assets/images/Mario/mikkey_death.png'))
    ...
    def update_image(self, core):
        ...
        if self.powerLVL in (0, 1, 2):
            ...
            # Player is running
                    ...
                    ((self.x_vel > 0 and core.keyR or core.keyR and not core.keyL) or
