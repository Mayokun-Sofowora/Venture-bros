...
from Schnoopas import Schnoopas
...
class Map(object):
    ...
    def loadWorld_11(self):
                ...
                for x in range(tmx_data.width):
                    ...
                    if image is not None:
                        ...
                        if layer.name == 'Foreground':
                            ...
                            # 22 ID is a question block, load all it's images
                            if tileID == 22:
                                image = (
                                    image,  # 1
        ...
        self.mobs.append(Schnoopas(1000, 352, True))
        ...
        self.mobs.append(Goombas(5720, 352, False))
    ...
    def spawn_schnoopas(self, x, y, move_direction):
        self.get_mobs().append(Schnoopas(x, y, move_direction))
    ...
    def spawn_score_text(self, x, y, score=None):
        ...
        if score is None:
            self.text_objects.append(Text(str(self.score_for_killing_mob), 12, (x, y)))
        ...
        # That case for all other situations.
            ...
            self.text_objects.append(Text(str(score), 12, (x, y)))
    ...
    def try_spawn_mobs(self, core):
        ...
        if self.get_player().rect.x > 2080 and not self.is_mob_spawned[0]:
            ...
            self.spawn_schnoopas(1000, 224, True)
            ...
            self.spawn_schnoopas(3300, 352, True)
            ...
            self.spawn_schnoopas(4100, 352, False)
    ...
    def remove_whizbang(self, whizzbang):
        self.projectiles.remove(whizzbang)
    ...
    def update(self, core):
        ...
        # Player's fireballs
        for whizzbang in self.projectiles:
            whizzbang.update(core)
