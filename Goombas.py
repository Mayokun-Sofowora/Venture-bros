...
class Goombas(Entity):
    def __init__(self, x_pos, y_pos, move_direction):
        ...
        self.images = [
            Filesystem.load_image('assets/images/goombas_0.png'),
            Filesystem.load_image('assets/images/goombas_1.png'),
            Filesystem.load_image('assets/images/goombas_dead.png')
        ]
